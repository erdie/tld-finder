    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-background text-foreground pb-20 selection:bg-primary/20 selection:text-primary">
                ...
                <header className="sticky top-0 z-40 bg-surface-container-lowest/80 dark:bg-surface-container-low/80 backdrop-blur-md transition-colors duration-300">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Badge variant="secondary" className="font-mono text-xs rounded-full border-none">
                                IANA Root Zone
                            </Badge>
                            <ThemeToggle />
                        </div>
                    </div>
                    <WavyDivider id="m3-header-wavy-border-detail" />
                </header>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 space-y-8">
                    ...
                    <section className="bg-surface-container-high rounded-3xl p-6 sm:p-8 shadow-elevation-1 relative overflow-hidden transition-all duration-300">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    <Badge variant="secondary" className="h-7 text-xs uppercase px-3 rounded-full font-bold border-none inline-flex items-center justify-center">
                                        {tldType}
                                    </Badge>
                            ...
                            {/* Date Badges */}
                            <div className="flex flex-col sm:flex-row md:flex-col gap-2.5 font-mono text-xs text-muted-foreground bg-surface-container-low p-4 rounded-2xl shadow-xs">
                    ...
                    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="bg-surface-container-low rounded-2xl p-5 shadow-xs space-y-2">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                            ...
                            <div className="bg-surface-container-low rounded-2xl p-6 shadow-xs space-y-3 flex flex-col justify-between">
                                <div>
                            ...
                            <div className="bg-surface-container-low rounded-2xl p-6 shadow-xs space-y-3 flex flex-col justify-between">
                                <div>
                                    <div className="flex items-center gap-2 mb-3">
                                        <div className="p-1.5 rounded-lg bg-primary-container text-on-primary-container flex items-center justify-center">
                                            <MaterialIcon name="person_check" className="text-[18px] text-primary" />
                                        </div>
                            ...
                            <div className="bg-surface-container-low rounded-2xl p-6 shadow-xs space-y-3 flex flex-col justify-between">
                                <div>
                                    <div className="flex items-center gap-2 mb-3">
                                        <div className="p-1.5 rounded-lg bg-tertiary-container text-on-tertiary-container flex items-center justify-center">
                                            <MaterialIcon name="build" className="text-[18px] text-tertiary" />
                                        </div>
                                        <h3 className="font-bold text-sm text-foreground uppercase tracking-wide">
                                            Technical Contact
                                        </h3>
                    ...
                    {detail?.nameServers && detail.nameServers.length > 0 && (
                        <section className="space-y-4">
                            ...
                            <div className="bg-surface-container-low rounded-2xl overflow-hidden shadow-xs">
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left text-xs font-mono">
                                        <thead className="bg-surface-container-high border-b border-surface-container-highest/60 text-muted-foreground font-sans font-semibold uppercase text-[11px]">
                                            <tr>
                    ...
                    {relatedTlds.length > 0 && (
                        <section className="space-y-4 pt-4 border-t border-surface-container-highest/60">
                                ...
                                {relatedTlds.map((tld, idx) => {
                                    ...
                                    return (
                                        <Link 
                                            key={idx}
                                            href={`/tld/${clean}`}
                                            className="p-3.5 bg-surface-container-low hover:bg-surface-container rounded-2xl transition-all duration-200 ease-[cubic-bezier(0.2,0,0,1)] active:scale-95 text-center space-y-1 group shadow-xs hover:shadow-elevation-1"
                                        >
